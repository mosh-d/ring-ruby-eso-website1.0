...
export default function AvailableRoomsSection() {
  ...
  // Deluxe has no uploaded photos yet — deliberately no entry here for it,
  // so it falls back to standardRoomImage/undefined gallery below rather
  // than pointing at a nonexistent asset.
