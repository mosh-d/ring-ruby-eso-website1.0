          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              ...
              <li>
                ...
                links to third-party websites. Ring Ruby Hotel Eso is not
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                of Ring Ruby Hotel Eso or its licensors and is protected by
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                your own risk. Ring Ruby Hotel Eso does not warrant that the
                website will be error-free or that access will be
                uninterrupted. The information provided is on an "as-is"
                basis.
              </li>
              <li>
                <strong>Limitation of Liability:</strong> Ring Ruby Hotel Eso shall
