export const generateHotelSchema = (hotelData = {}) => {
  const defaultData = {
    ...
    url: "https://eso.ringrubyhotel.com",
    logo: "https://eso.ringrubyhotel.com/ring%20ruby%20logo.webp",
    priceRange: "$$",
    starRating: {
      "@type": "Rating",
      ratingValue: "4.5",
  ...
  const defaultItems = [
    {
      ...
      position: 1,
      name: "Home",
      item: "https://eso.ringrubyhotel.com",
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Rooms",
      item: "https://eso.ringrubyhotel.com/rooms",
    },
  ];
